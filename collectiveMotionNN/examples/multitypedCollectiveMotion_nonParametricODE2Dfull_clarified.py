...
def main(kappa=None, cutoff=None, r=None, u0=None, beta=None, A_CIL=None, A_ext=None,
    ...
    MCM_Module = mcmf.interactionModule_nonParametric_2Dfull(MCM_params, sigma, N_dim, N_celltypes, N_embedding, NNshape, NN2shape, NN3shape, NN4shape, NNbias, NN2bias, NN3bias, NN4bias, periodic, NNactivationName, NNactivationArgs, useScaling=NNscalingLayer, usescalingBias=NNscalingBias).to(device)
