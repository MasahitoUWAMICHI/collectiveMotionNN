...
class interactionModule(nn.Module):
    def __init__(self, c, r_c, p=2, gamma=0.0, sigma=0.1, Ndim=2, periodic=None, positionName=None, velocityName=None, accelerationName=None, noiseName=None, messageName=None):
        super().__init__()
