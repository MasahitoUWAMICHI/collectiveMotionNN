...
def main_parser():
    ...
    parser.add_argument('--shuffle_celltype', type=strtobool)
...
def parser2main(args):
    main(kappa=args.kappa, cutoff=args.cutoff, r=args.r, u0=args.u0, beta=args.beta, A_CIL=args.A_CIL, A_ext=args.A_ext,
         ...
         ratio_celltypes=args.ratio_celltypes, shuffle_celltype=args.shuffle_celltype,
...
def main(kappa=None, cutoff=None, r=None, u0=None, beta=None, A_CIL=None, A_ext=None,
         ...
         ratio_celltypes=None, shuffle_celltype=None,
    ...
    shuffle_celltype = ut.variableInitializer(shuffle_celltype, True)
    ...
    save_learned_model = ut.variableInitializer(save_learned_model, 'Mcm_nonParametric2DsymClassify_learned_model.pt')
    save_loss_history = ut.variableInitializer(save_loss_history, 'Mcm_nonParametric2DsymClassify_loss_history.pt')
    save_validloss_history = ut.variableInitializer(save_validloss_history, 'Mcm_nonParametric2DsymClassify_validloss_history.pt')
    save_lr_history = ut.variableInitializer(save_lr_history, 'Mcm_nonParametric2DsymClassify_lr_history.pt')
    
    save_run_time_history = ut.variableInitializer(save_run_time_history, 'Mcm_nonParametric2DsymClassify_run_time_history.npy')
    save_params = ut.variableInitializer(save_params, 'Mcm_nonParametric2DsymClassify_parameters.npy')
    ...
    x0, _, graph_init = mcm_ut.init_graph(L, N_particles, N_dim, N_batch, N_particles_ct, shuffle_celltype)
    ...
    train_loader, valid_loader, test_loader = mcm_ut.makeGraphDataLoader(os.path.join(save_directory_simulation, save_x_SDE),
                                                                         ...
                                                                         drop_last=False, shuffle=True, pin_memory=True, hideCelltype=True)
