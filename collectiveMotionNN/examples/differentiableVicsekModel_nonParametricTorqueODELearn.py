...
def parser2main(args):
    main(v0=args.v0, w0=args.w0, sigma=args.sigma, d=args.d, r0=args.r0, L=args.L,
         ...
         v0_init=args.v0_init, sigma_init=args.sigma_init,  fNNshape=args.fNNshape, fBias=args.fBias,
...
def main(v0=None, w0=None, sigma=None, d=None, r0=None, L=None,
         ...
         skipSimulate=None,
         v0_init=None, sigma_init=None, fNNshape=None, fBias=None,
    ...
    fNNshape = ut.variableInitializer(fNNshape, None)
    fBias = ut.variableInitializer(fBias, None)
