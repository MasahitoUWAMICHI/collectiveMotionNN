...
class study_wrapper():
    def __init__(study_path, device=None, make_study=None, replace_params=None,
                 ...
                 save_params=None):
        self.init_def_objective(c, r_c, p, gamma, sigma, r0, L, v0,
                                N_dim, N_particles, N_batch, 
                                t_max, dt_step, dt_save, 
                                periodic, selfloop, 
                                save_directory_simulation,
                                save_x_SDE, save_t_SDE, save_model,
                                method_SDE, noise_type, sde_type, bm_levy,
                                skipSimulate,
                                gamma_init, sigma_init,
                                NNshape, NNbias, NN2shape, NN2bias,
                                NNactivationName, NNactivationArgs,
                                NNscalingLayer, NNscalingBias,
                                NNreset_weight_method, NNreset_weight_args,
                                NNreset_bias_method, NNreset_bias_args,
                                NNreset_others_method, NNreset_others_args,
                                NN_zeroFinalLayer, NN2_zeroFinalLayer,
                                delayPredict, dt_train, 
                                method_ODE, 
                                N_epoch, N_train_batch, N_batch_edgeUpdate,
                                N_train_minibatch_integrated,
                                ratio_valid, ratio_test,
                                split_seed_val,
                                lr, optimName, optimArgs, highOrderGrad,
                                lrSchedulerName, lrSchedulerArgs,
                                vLoss_weight, scoreLoss_weight, 
                                useScore,
                                nondimensionalLoss,
                                save_directory_learning,
                                save_learned_model, 
                                save_loss_history, save_validloss_history,
                                save_lr_history,
                                save_run_time_history,
                                save_params)
        self.study_path = study_path
        

    def init_def_objective(self, c, r_c, p, gamma, sigma, r0, L, v0,
                           N_dim, N_particles, N_batch, 
                           t_max, dt_step, dt_save, 
                           periodic, selfloop, 
                           save_directory_simulation,
                           ...
                           save_run_time_history,
                           save_params):
        self.def_objective = self.def_def_objective(c, r_c, p, gamma, sigma, r0, L, v0,
                                                    N_dim, N_particles, N_batch, 
                                                    t_max, dt_step, dt_save, 
                                                    periodic, selfloop, 
                                                    save_directory_simulation,
    ...
    def def_def_objective(self, c, r_c, p, gamma, sigma, r0, L, v0,
                          N_dim, N_particles, N_batch, 
                          t_max, dt_step, dt_save, 
                          periodic, selfloop, 
                          save_directory_simulation,
                          ...
                          save_run_time_history,
                          save_params):
        return lambda trial, device: simulate_and_run(trial, device, 
                                                      c, r_c, p, gamma, sigma, r0, L, v0,
                                                      N_dim, N_particles, N_batch, 
                                                      t_max, dt_step, dt_save, 
                                                      periodic, selfloop, 
                                                      save_directory_simulation,
...
def simulate_and_run(trial, device=None, 
                     c=None, r_c=None, p=None, gamma=None, sigma=None, r0=None, L=None, v0=None,
                     N_dim=None, N_particles=None, N_batch=None, 
                     t_max=None, dt_step=None, dt_save=None, 
                     periodic=None, selfloop=None, 
